<template>
  <v-container fluid class="bg-light-blue-darken-3">
    <v-row>
      <v-col cols="12">
        <h2>Traductor</h2>
      </v-col>
      <v-col cols="6">
        <v-select
          label="Selecionar el idioma de la palabra a ingresar"
          v-model="palabraIdioma"
          :items="idiomas"
          item-title="name"
          item-value="code"
        ...
        <v-textarea
          clearable
          label="Ingresar una palabra"
          v-model="palabraIngresar"
          bg-color="deep-purple-lighten-5"
        ></v-textarea>
      </v-col>
      <v-col cols="6">
        <v-select
          label="Selecionar un idioma a traducir"
